...
/**
 * Facebook social bookmark service.
 *
 * @author Richard "Shred" Körber
 */
@Component
@SocialHandler
public class FacebookSocialHandler {

    /**
     * Facebook
     */
    @SocialBookmark(icon = "facebook.png")
    @Priority(9)
    public String facebookSocialBookmark(@PageLink(encoded = true) String pageLink) {
        return "http://www.facebook.com/share.php?u=" + pageLink;
    }
